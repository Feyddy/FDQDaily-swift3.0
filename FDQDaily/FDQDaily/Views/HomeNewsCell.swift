...
//                    if (manager.diskImageExists(for: <#T##URL?#>, completion: <#T##SDWebImageCheckCacheCompletionBlock?##SDWebImageCheckCacheCompletionBlock?##(Bool) -> Void#>))  {// 缓存中有 不再加载
//                        return
//                    } else {
