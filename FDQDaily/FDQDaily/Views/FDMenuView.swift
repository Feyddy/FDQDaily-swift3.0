...
class FDMenuView: UIView {
    ...
    /**新闻分类菜单界面*/
    fileprivate var newsClassificationView: FDNewClassificationView?
    ...
    fileprivate func setupUI()  {
        ...
        // 新闻分类view
        newsClassificationView = FDNewClassificationView()
...
extension FDMenuView: UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate
{
